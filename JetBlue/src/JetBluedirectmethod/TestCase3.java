...
public class TestCase3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);
        //open the CheckStatus page
        driver.findElement(By.cssSelector("body > jb-app > jb-flight-tracker > jb-flight-tracker-search > div > div > form > div > button > span > span")).click();
    }
